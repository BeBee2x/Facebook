...
<div class="container-fluid mt-5">
    ...
    <div class="row" style="position: relative">
        ...
        <div class="col-4 bg-white min-vh-100" style="position: fixed;top:50px;left:0px">
            <div class="d-flex justify-content-between">
                <div class="h4 mt-5 fw-bold" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Videos</div>
                <div class="mt-5">
            ...
            <form action="{{ route('facebook-search',$searchFrom) }}" method="get">
                <div class="input-group mt-3">
                    <input type="text" name="searchKey" class="form-control border-0 shadow-sm" placeholder="Search videos" style="background-color: #F0F2F5">
            ...
            <hr>
            <button class="w-100 btn d-flex text-start py-2 my-3 align-items-center rounded-3" style="background-color: #F0F2F5">
                <i class="fa-solid fa-tv text-white" style="background-color: #1877F2;padding:10px 9px;border-radius:50%"></i>
                <div class="fw-bold ms-2 fw-bold">Home</div>
            </button>
        </div>
        <div class="col-8 d-flex justify-content-center" style="position: absolute;top:0px;right:0px">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-10 p-3 bg-white mt-5 d-flex justify-content-between rounded-3 shadow-sm align-items-center">
                        <div>
                            <h5 class="fw-bold" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Create your video</h5>
                            <i class="fa-solid fa-camera-retro text-danger ms-3 me-2"></i>
                            <i class="fa-solid fa-video text-primary me-2"></i>
                            <i class="fa-solid fa-clapperboard text-warning me-2"></i>
                            <i class="fa-solid fa-icons text-success me-2"></i>
                        </div>
                        <div class="btn border-0" data-bs-toggle="modal" data-bs-target="#createVideo">
                                                                ...
                                                                <a href="{{ route('facebook-userProfile', $share_item->user_id) }}"
                                                                    ...
                                                                    @if ($share_item->user_image == null)
                                                                        <img src="{{ asset('images/default-user.jpg') }}"
                                                                            ...
                                                                            style="height:47;object-fit:cover;object-position:center">
                                                                    @else
            ...
            ">
                    ...
                    @endforeach
                    @if ($post_count == 0)
                        <div class="text-center fw-bold mt-4">There is no video now yet! Come back later <i
    ...
    <div class="modal" id="createVideo" style="backdrop-filter: blur(5px)">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between align-items-center">
                    <div></div>
                    <div class="h5 text-black fw-bold" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Create your video</div>
                    <div><button class="btn-close rounded-circle border-0 text-black" data-bs-dismiss="modal" style="background-color: #D8DADF"></button></div>
                </div>
                <form action="{{ route('facebook-uploadVideo') }}" method="post"
                ...
                <div class="modal-body">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-8">
                            <a href="{{ route('facebook-userProfile', Auth::user()->id) }}"
                                ...
                                class="text-black fw-bold text-decoration-none d-block"
                                style="margin-left: -10px">{{ Auth::user()->name }}</a>
                                <button type="button" class="btn btn-sm fw-bold border-0" style="background-color: #E4E6EB;margin-left:-14px"><i class="fa-solid fa-user-group" style="font-size:12px"></i> Friends</button>
                        </div>
                    </div>
                    <textarea name="caption" class="form-control border-0 w-100 fs-5 form-control-sm my-3"
                        placeholder="What's on your mind,{{ Auth::user()->name }}?"></textarea>
                    <div>
                        <input type="file" name="video" class="form-control my-2 border-2 @error('video') is-invalid @enderror"
                    ...
                    <div class="d-flex justify-content-between p-3"
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn border-0"><i
                                    class="fa-solid fs-5 fa-flag text-info"></i></button>
                            <button type="button" class="btn border-0"><i class="fa-solid fa-ellipsis"></i></button>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
