...
<div class="bg-light min-vh-100">
    ...
    <div class="row d-flex justify-content-center">
        <div class="d-flex p-2 w-100 mb-1 pb-0 align-items-center" style="position:fixed;top:3px;left:20px">
            @if ($from==0)
            <a href="{{ route('facebook-home') }}"><i class="fa-solid fa-xmark fs-4 text-black me-3"></i></a>
            @else
            <a href="{{ route('facebook-savedPage') }}"><i class="fa-solid fa-xmark fs-4 text-black me-3"></i></a>
            @endif
            <div><i class="fa-brands fa-facebook text-primary fs-1 bg-white rounded-circle" style="padding:2px"></i></div>
        </div>
        <div class="modal" id="deleteconfirm{{ $post->id }}" style="backdrop-filter: blur(5px)">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer border-0 d-flex justify-content-end">
                        ...
                        <a href="{{ route('facebook-deletePost',$post->id) }}" class="btn btn-primary text-white fw-bold px-4">Confirm</a>
                    </div>
                </div>
            </div>
        </div>
        @if ($post->type==1)
            <div class="col-5 bg-white shadow p-2 rounded-2">
                ...
                @endif
                <div class="card bg-white mt-3 rounded-3 border border-1 p-3">
                    ...
                    <div class="card-body">
                        <div class="d-none">
                            ...
                            @if($post->image!=null)
                            <div id="photo">
                                <a href="{{ route('facebook-postDetails',[$post->id,$from]) }}" onclick="location.reload()">
        ...
        <div class="card col-5 bg-white shadow mt-3 rounded-3 border border-1 p-3">
            ...
            <div class="card-footer border-0 pt-0" style="background-color:white;margin-top:-20px">
                <div class="row" id='post'>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center mb-2 mt-3" style="cursor: pointer" data-bs-toggle="modal" data-bs-target="{{ '#likes'.$post->id }}"><i class="fa-solid fa-thumbs-up text-light rounded-circle p-1" style="background-color:#119AF6;font-size:10px"></i><span class="like ms-2" id="likenumber{{ $post->id }}">{{ $post->like }}</span></div>
                        <div class="modal" id="{{ 'likes'.$post->id }}">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header w-100 d-flex justify-content-between">
                                        <div>
                                            <button class="btn btn-light d-flex align-items-center"><i class="fa-solid fa-thumbs-up text-light rounded-circle p-1" style="background-color:#119AF6;font-size:10px"></i><div class="like ms-2" id="likenumber2{{ $post->id }}">{{ $post->like }}</div></button>
                                        </div>
                                        <div>
                                    ...
                                    <div class="modal-body">
                                        <div class="row likelist{{ $post->id }}" id="likeList">
                                            <div class="d-none">
                                                {{ $like_check=false }}
                                            </div>
                                            ...
                                            @endforeach
                                            @if ($like_check==false)
                                                <div class="col-12 d-flex justify-content-center fw-bold toHide" id="toHide{{ $post->id }}">
                    ...
                    @for ($i=0;$i<count($post_you_like);$i++)
                        @if ($post_you_like[$i]->post_id==$post->id)
                            <div class="d-none">
                                {{ $checkLikedOrNot=1 }}
                            </div>
                        @endif
                    ...
                    <input type="hidden" class="likecheck{{ $post->id }}" id="likeCheck" value="1">
                    <button class="btn btn-hover w-100 text-muted fw-bold unlikeBtn" id="likeBtn{{ $post->id }}"><i class="fa-solid fa-thumbs-up fs-5 text-primary unlikeIcon" id="likeIcon{{ $post->id }}"></i> Like</button>
                    @else
                    <input type="hidden" class="likecheck{{ $post->id }}" id="likeCheck" value="0">
                    <button class="btn btn-hover w-100 text-muted fw-bold likeBtn" id="likeBtn{{ $post->id }}"><i class="fa-regular fa-thumbs-up fs-5 likeIcon" id="likeIcon{{ $post->id }}"></i> Like</button>
                    @endif
                    <button class="btn btn-hover w-100 text-muted fw-bold"><i class="fa-solid fa-share fs-5"></i> Share</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="d-flex justify-content-center">
        <div class="row mt-4 col-5 d-flex align-items-center">
            <div class="col-2">
                <a href="{{ route('facebook-userProfile',Auth::user()->id) }}" onclick="location.reload()">
                    @if (Auth::user()->image==null)
                        <img src="{{ asset('images/default-user.jpg') }}" class="rounded-circle w-75 ms-3" style="height:47px;object-fit:cover;object-position:center">
                    @else
                        <img src="{{ asset('storage/'.Auth::user()->image) }}" class="rounded-circle w-75 ms-3" style="height:47px;object-fit:cover;object-position:center">
                    @endif
                </a>
            </div>
            <div class="col-10">
    ...
    <div class="d-flex justify-content-center">
        <div class="row col-5 mt-4 ms-1" id="commentSection">
